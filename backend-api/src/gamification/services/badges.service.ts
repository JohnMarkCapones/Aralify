...
export class BadgesService {
  ...
  /**
   * Evaluate whether a user has earned any new badges.
   * Badge grants are handled explicitly (e.g. via admin or specific events).
   * This hook exists for the gamification pipeline and returns an empty array
   * until automatic badge criteria evaluation is implemented.
   */
  async evaluateForUser(_userId: string): Promise<{ id: string; slug: string; title: string }[]> {
    return [];
  }
